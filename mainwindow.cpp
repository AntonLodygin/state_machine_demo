...
void MainWindow::on_butOpen_clicked()
{
    ...
    foreach (QGraphicsItem *item, SvgReader::getElements(path)) {
        ...
        case QGraphicsRectItem::Type: {
            ...
            connect(rect, &Rectangle::clicked, workplaceScene, &VEWorkplace::signalSelectItem);
            // connect(rect, &Rectangle::signalMove, workplaceScene, &VEWorkplace::slotMove);
            break;
        }
        default:
            break;
