...
void VERectangleSettings::newRectangle(Rectangle *rect)
{
    if(ui->comboBox->currentIndex() == 0){
...
void VERectangleSettings::loadRectangle(Rectangle *rect)
{
...
void VERectangleSettings::setGradient(Rectangle *rectangle)
{
